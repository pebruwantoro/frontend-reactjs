...
import { userCreateNewAccount } from "../../api/UserApi";
import { alertError, alertSuccess } from "../../lib/alert";
import { UserRole } from "../../constants/Users";

export default function UserSellerRegister() {
    ...
    async function handleSubmit(e) {
        ...
        const response = await userCreateNewAccount(token, {name, email, password, role})
    ...
    return <>
        <div className="animate-fade-in bg-gray-800 bg-opacity-80 p-8 rounded-xl shadow-custom border border-gray-700 backdrop-blur-sm w-full max-w-md">
            <div className="text-center mb-8">
                ...
                <p className="text-gray-300 mt-2">Create a new seller account</p>
            </div>
